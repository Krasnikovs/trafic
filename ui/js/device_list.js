		...
		success : function(data) {
			if(data["status"] == "Success") {
				...
				for(var i = 0; i < data["devices"].length; i++) {
					...
					html += "<tr><td style='cursor: pointer;' onclick=setSingleDevice('" + data["devices"][i]["client_id"] +"')>"+ data["devices"][i]["device"] +"</td><td style='cursor: pointer;' onclick=setSingleDevice('"+ data["devices"][i]["client_id"] +"')>"+ data["devices"][i]["client_id"] +"</td><td style='cursor: pointer;' onclick=setSingleDevice('" + data["devices"][i]["client_id"] +"')>"+ device_status[data["devices"][i]["connect_status"]] +"</td><td style='cursor: pointer;' onclick=setSingleDevice('" + data["devices"][i]["client_id"] +"')>"+ data["devices"][i]["ip"] +"</td><td style='cursor: pointer;' onclick=setSingleDevice('" + data["devices"][i]["client_id"] +"')>"+ dateString(data["devices"][i]["time"])+"</td><td>"+cleanbutn+"</td></tr>"
				}
