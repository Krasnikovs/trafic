	...
	$.ajax({
		...
		success : function(data) {
			if(data["status"] == "Success") {
				...
				{
					$("#single-device-topic").html(data["will_detail"]["will_topic"]);
					$("#single-device-qos").html(data["will_detail"]["will_QoS"]);
					$("#single-device-message").html(data["will_detail"]["will_message"]);
				}
			}
		}
	})
	...
	$.ajax({
		...
		success : function(data) {
			if(data["status"] == "Success") {
				...
				$(".device-send-success").text("Message send to " + $("#single-device-id").text());
